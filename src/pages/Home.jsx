        ...
        <>
            ...
            <main className="home-body">
                ...
                <div className="about" id="faq">
                    ...
                    <div className="text">Yes, we recommend that you work with a team, since it is a great way to find solutions and to have fun. Teams consist of 1-4 members, but if you want to work alone, you can.</div>
